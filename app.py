...
tokenizer = DistilBertTokenizer.from_pretrained(r'C:\Users\Aniket\Desktop\sentiment-analysis-web-app\app\model')
model = DistilBertForSequenceClassification.from_pretrained(r'C:\Users\Aniket\Desktop\sentiment-analysis-web-app\app\model')

# Mapping of model output labels to emotions
label_dict = {
...
def analyze():
    ...
    # Retrieve emotion and confidence
